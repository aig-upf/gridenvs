...
class Colors:
    @classmethod
    def hex_to_rgb(cls, h):
        assert len(h) >= 6
        return int(h[-6:-4], base=16), int(h[-4:-2], base=16), int(h[-2:], base=16)

    @classmethod
    def rgb_to_hex(cls, rgb, header='0x'):
        return header + hex(rgb[0])[2:].zfill(2) + hex(rgb[1])[2:].zfill(2) + hex(rgb[2])[2:].zfill(2)
    ...
    distinguishable_alphabet = OrderedDict([("Amethyst", (240, 163, 255)),
                                            ("Blue", (0, 117, 220)),
                                            ("Caramel", (153, 63, 0)),
                                            ("Damson", (76, 0, 92)),
                                            ("Ebony", (25, 25, 25)),
    ...
    distinguishable_hex = ["#FFFF00", "#1CE6FF", "#FF34FF", "#FF4A46", "#008941", "#006FA6", "#A30059", # #000000
